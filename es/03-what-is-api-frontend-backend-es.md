...
## Arquitectura API de vibefast.app

vibefast.app usa **Service Binding** para que el frontend y el backend se comuniquen directamente dentro de la red interna de Cloudflare, no a través de internet público.

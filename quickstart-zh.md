...
- [為什麼 Cloudflare 是 Vibe Coding 的最佳選擇？](./zh/05-the-best-way-to-vibecoding-on-cloudflare-zh.md) — 和 Next.js + Vercel 方案的直接對比
- [Cloudflare Workers 和傳統伺服器有什麼不同？](./zh/06-cloudflare-workers-vs-traditional-server-zh.md) — 邊緣架構的實際好處
